    ...
    <>
      ...
      <div className="border justify-center items-center rounded-md max-w-3xl mx-auto py-14 ">
        <form onSubmit={handleOnSubmit} className="max-w-xl mx-auto shadow-xs ">
          ...
          <button
            type="submit"
            className="text-white bg-orange-500 hover:bg-orange-400 transition hover:shadow-lg focus:ring-4 focus:outline-none focus:ring-orange-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center "
          >
            Submit
          </button>
        </form>
          ...
          {isButtonLoading ? (
            ...
            <div className="flex items-center justify-center">
              <button
                ...
                className="mt-8 bg-orange-500 text-white px-4 py-2 rounded items-center justify-center hover:bg-orange-400 hover:shadow-lg transition-all"
              >
                Load More
              </button>
            </div>
